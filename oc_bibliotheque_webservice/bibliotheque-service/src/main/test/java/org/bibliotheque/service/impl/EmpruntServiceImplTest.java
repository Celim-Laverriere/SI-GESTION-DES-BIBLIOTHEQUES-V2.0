...
class EmpruntServiceImplTest {
    ...
    void getEmpruntById() throws ParseException {
        ...
        EmpruntEntity empruntMock = EmpruntEntity.builder()
                .id(1)
                .dateDebut(dateFormat.parse("2019-12-20"))
                .dateFin(dateFormat.parse("2020-01-13"))
                .statut("En cours")
                .prolongation(false)
                .livreId(2)
                .compteId(3)
    ...
    void getAllEmprunts() {
        ...
        empruntEntityList = empruntServiceImpl.getAllEmprunts();
